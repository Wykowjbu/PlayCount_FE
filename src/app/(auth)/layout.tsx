...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[1.15fr_0.85fr]">
      ...
      <div className="relative hidden lg:flex min-h-screen flex-col justify-between border-r border-gray-200 px-12 py-8 overflow-hidden bg-gradient-to-br from-white via-green-50/30 to-green-100/20">
        {/* Decorative circles */}
        ...
        {/* Main Copy */}
        <div className="relative z-10 max-w-[650px] mx-0 my-auto py-12">
        ...
        {/* Proof */}
        <div className="relative z-10 flex gap-2.5 items-center text-gray-700">
      ...
      {/* Form Panel - Bên phải */}
      <main className="grid min-h-screen place-items-center px-6 py-10 bg-white">
        {children}
      </main>
    </div>
  )
