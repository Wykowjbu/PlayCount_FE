    ...
    <div className={className}>
      ...
      >
        ...
        >
          ...
          <SelectPrimitive.Icon className="shrink-0 transition-transform duration-150 data-[state=open]:rotate-180">
        ...
        <SelectPrimitive.Portal>
          <SelectPrimitive.Content
            ...
            style={{
              ...
              width: "max(var(--radix-select-trigger-width), 220px)",
          ...
          >
            <SelectPrimitive.ScrollUpButton className="flex h-7 cursor-default items-center justify-center text-[var(--pc-mute)]">
            ...
            <SelectPrimitive.Viewport className="p-1.5">
              {options.map((option, i) => (
                ...
                >
                  ...
                  <span className="relative z-10 flex h-full items-center whitespace-nowrap pl-9 pr-3 text-[var(--pc-body)] data-[state=checked]:font-semibold">
                    <span className="absolute left-3 flex h-4 w-4 items-center justify-center">
                      <SelectPrimitive.ItemIndicator>
                        <Check className="h-4 w-4 text-[var(--pc-green-800)]" aria-hidden="true" />
                      </SelectPrimitive.ItemIndicator>
                    </span>
                    <SelectPrimitive.ItemText className="block min-w-0 truncate whitespace-nowrap text-inherit">
                      {option.label}
            ...
            <SelectPrimitive.ScrollDownButton className="flex h-7 cursor-default items-center justify-center text-[var(--pc-mute)]">
