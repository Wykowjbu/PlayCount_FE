...
export function VenueCard({
  ...
  return (
    <div className={`border border-[var(--pc-hairline)] rounded-[12px] bg-white overflow-hidden shadow-sm flex hover:border-[var(--pc-faint)] transition-all group duration-300 ${
      isWide ? 'flex-col md:flex-row md:items-stretch' : 'flex-col'
    }`}>
      {/* Aspect Ratio Image Container */}
      <div className={`overflow-hidden relative bg-neutral-50 shrink-0 ${
        isWide
        ...
        {image ? (
          ...
          <div className="w-full h-full flex items-center justify-center text-[var(--pc-mute)] bg-[var(--pc-hairline-soft)] font-medium text-xs">
            Không có ảnh
          </div>
        )}
      </div>
      ...
      <div className={`p-4 flex flex-col gap-2.5 flex-grow ${
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-1 my-1">
            <span className="text-[11px] font-medium text-[var(--pc-mute)]">Suất trống tiếp theo:</span>
